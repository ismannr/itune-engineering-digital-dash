...
void create_screen_main() {
    ...
    lv_obj_set_size(obj, 800, 480);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_style_line_color(obj, lv_color_hex(0x000000), LV_PART_ITEMS);
            lv_obj_set_style_line_opa(obj, 100, LV_PART_ITEMS);
            lv_obj_set_style_length(obj, 20, LV_PART_INDICATOR);
            lv_obj_set_style_line_width(obj, 3, LV_PART_INDICATOR);
            lv_obj_set_style_line_opa(obj, 100, LV_PART_INDICATOR);
            lv_obj_set_style_text_font(obj, &lv_font_montserrat_34, LV_PART_INDICATOR);
            {
                lv_obj_t *parent_obj = obj;
                {
                    // Needle
                    ...
                    lv_obj_set_style_align(obj, LV_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_scale_set_line_needle_value(parent_obj, obj, 150, 0);
                }
                {
